...
UNTRACKED_TRANSACTIONS_JSON_FILE = current_dir.parent.joinpath("data").joinpath(
    "untracked_transactions.json"
)
INITIAL_TRANSACTIONS_JSON_FILE = current_dir.parent.joinpath("data").joinpath(
    "initial_transactions.json"
)
...
class DBWrapper:
    ...
    def db_sync(self, transaction_list: list):
        ...
        with open(INITIAL_TRANSACTIONS_JSON_FILE, "r", encoding="utf-8") as json_file:
            transaction_list_temp = json.load(json_file)
        insert_transcation_from_list(transaction_list_temp)
        ...
        insert_transcation_from_list(transaction_list)
...
def insert_transcation_from_list(transaction_list: str):
